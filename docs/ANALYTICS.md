...
- [traffic-analytics.md](traffic-analytics.md) — 서버 수집·릴레이 계약
- 모노레포 `web/README.md` — 프론트 계측과 개인정보 고지
- [ADR-005](decisions/ADR-005-first-party-analytics.md) — 자체 수집을 둔 배경
